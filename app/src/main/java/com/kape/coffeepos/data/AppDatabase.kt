...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        internal val MIGRATION_21_22 = object : Migration(21, 22) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE PaymentMethod ADD COLUMN createdAt INTEGER NOT NULL DEFAULT 0")
                db.execSQL("ALTER TABLE PaymentMethod ADD COLUMN updatedAt INTEGER NOT NULL DEFAULT 0")
                db.execSQL("ALTER TABLE StoreSettings ADD COLUMN paymentVoidSettingsUpdatedAt INTEGER NOT NULL DEFAULT 0")
            }
        }
        ...
        internal val MIGRATION_23_24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE StoreSettings ADD COLUMN businessDayCutoffMinutes INTEGER NOT NULL DEFAULT 120")
                db.execSQL("ALTER TABLE StoreSettings ADD COLUMN businessDaySettingsUpdatedAt INTEGER NOT NULL DEFAULT 0")
            }
        }
