...
const TABLES = {
  ...
  store_settings: { role: 'manager', keys: ['id'], columns: ['id', 'store_name', 'tax_rate_percent', 'tip_presets', 'receipt_footer', 'senior_discount_percent', 'pwd_discount_percent', 'void_refund_pin'] },
  ...
  pos_order: { role: 'counter', keys: ['id'], columns: ['id', 'status', 'employee_id', 'shift_id', 'shift_device_id', 'subtotal_cents', 'discount_cents', 'tax_cents', 'tip_cents', 'total_cents', 'created_at', 'paid_at', 'void_reason', 'customer_name', 'table_number', 'order_type'], immutable: true },
